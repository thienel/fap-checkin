...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      debugPrint(
        'LOGIN FirebaseAuthException: code=${error.code}, message=${error.message}, plugin=${error.plugin}\n$stack',
      );
      setState(
        () => _error = switch (error.code) {
          'invalid-credential' =>
            'Email hoặc mật khẩu không đúng. [invalid-credential]',
          ...
          'too-many-requests' =>
            'Thử lại sau vì có quá nhiều lần đăng nhập. [too-many-requests]',
          'keychain-error' =>
            'macOS chưa cấp quyền Keychain cho ứng dụng. Hãy kiểm tra '
                'Keychain Sharing và cấu hình ký ứng dụng.',
          'internal-error' => 'Lỗi nội bộ Firebase (Internal error). Vui lòng kiểm tra Email/Password Sign-in method đã bật trong Firebase Console chưa.',
